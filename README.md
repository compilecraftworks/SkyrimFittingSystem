...
`build/v1.4.6/windows/x64/<mode>/` in the project root.
...
`Skyrim Fitting System v1.4.6.zip`
...
SFS v1.4.6 exports a stable menu API for external hotkey and menu-management
...
The v1.4.6 module name is `SFSCore.dll`; the four C export names are unchanged.

SFS v1.4.6 includes the Kit Generator directly in `SFSCore.dll`. Its tab scans
...
state. See `docs/RELEASE-NOTES-v1.4.6.md` for their exact scope.
