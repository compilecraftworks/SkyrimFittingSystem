...
[Korean](docs/RELEASE-NOTES-v1.6.8-ko.md) notes and
[lifecycle audit](docs/V1.6.8-ACTOR-RESOURCE-LIFECYCLE.md).
...
for the 16-test verification scope and remaining in-game verification limits.
