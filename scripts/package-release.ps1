...
$sourceDocs = @(
    'RELEASE-NOTES-v1.7.0.md', 'RELEASE-NOTES-v1.7.0-ko.md',
    'V1.7.0-INLINE-DETOUR-FIX.md', 'GITHUB-RELEASE-v1.7.0.md',
    'nexus-changelog-v1.7.0-en.txt', 'nexus-changelog-v1.7.0-ko.txt',
    'RELEASE-NOTES-v1.6.9.md', 'RELEASE-NOTES-v1.6.9-ko.md',
    'V1.6.9-TRANSACTION-REGRESSION-FIXES.md',
    'V1.6.9-STATE-BOUNDARY-FIXES.md', 'GITHUB-RELEASE-v1.6.9.md',
    'nexus-changelog-v1.6.9-en.txt', 'nexus-changelog-v1.6.9-ko.txt',
    'RELEASE-NOTES-v1.6.8.md', 'RELEASE-NOTES-v1.6.8-ko.md',
    'GITHUB-RELEASE-v1.6.8.md',
    'nexus-changelog-v1.6.8-en.txt', 'nexus-changelog-v1.6.8-ko.txt',
    'V1.6.8-ACTOR-RESOURCE-LIFECYCLE.md',
    'RELEASE-NOTES-v1.6.7.md', 'RELEASE-NOTES-v1.6.7-ko.md',
    'GITHUB-RELEASE-v1.6.7.md',
    'nexus-changelog-v1.6.7-en.txt', 'nexus-changelog-v1.6.7-ko.txt',
    'HH-OFFSET-AND-INVENTORY-AUDIT-2026-09-19.md',
    'RELEASE-NOTES-v1.6.6.md', 'RELEASE-NOTES-v1.6.6-ko.md',
    'GITHUB-RELEASE-v1.6.6.md',
    'nexus-changelog-v1.6.6-en.txt', 'nexus-changelog-v1.6.6-ko.txt',
    'V1.6.6-GAMETASK-API-AUDIT.md',
    'RELEASE-NOTES-v1.6.5.md', 'RELEASE-NOTES-v1.6.5-ko.md',
    'GITHUB-RELEASE-v1.6.5.md',
    'nexus-changelog-v1.6.5-en.txt', 'nexus-changelog-v1.6.5-ko.txt',
    'DEVELOPMENT-v1.6.5-RENDERED-OUTFIT-API.md', 'DEVELOPMENT-v1.6.5-IED-AND-UI.md',
    'RELEASE-NOTES-v1.6.4.md', 'RELEASE-NOTES-v1.6.4-ko.md',
    'GITHUB-RELEASE-v1.6.4.md',
    'nexus-changelog-v1.6.4-en.txt', 'nexus-changelog-v1.6.4-ko.txt',
