...
public:
  ...
  [[nodiscard]] KeyHandlerEvent
  Register(uint32_t dxScanCode, KeyEventType eventType, KeyCallback callback);
...
private:
  ...
  ProcessEvent(RE::InputEvent *const *a_eventList,
...
//
// KeyHandlerEvent G_downEventHandler = keyHandler->Register(G_KEY,
