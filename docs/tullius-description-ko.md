...
- HT2 설치 상태에서 작업대 액터를 플레이어에서 새 NPC로 전환할 때 발생하던 SFSCore CTD를 수정했습니다. 중복 활성효과 목록 보조 판정을 제거하고 HT2 모니터 Spell·정확한 머리 장비 AddSpell/RemoveSpell 신호·액터별 FormID 캐시만 사용합니다.
...
4. v1.5.4 본체 ZIP을 새 모드로 설치하고 `SkyrimFittingSystem-VirtualTokens.esl`을 활성화합니다.
